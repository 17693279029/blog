  ...
  <section>
    ...
    >
      <a-form-item name="title">
        <a-input
          v-model:value="state.query.params.title"
          allowClear
          placeholder="请输入工具名称"
          @pressEnter="goPage"
          autocomplete="off"
      ...
      <a-form-item name="icon">
        <a-input
          v-model:value="state.query.params.icon"
          allowClear
          placeholder="请输入工具图标"
          @pressEnter="goPage"
          autocomplete="off"
      ...
      <a-form-item name="abstract">
        <a-input
          v-model:value="state.query.params.abstract"
          allowClear
          placeholder="请输入工具简介"
          @pressEnter="goPage"
          autocomplete="off"
      ...
      <a-form-item name="category">
        <a-input
          v-model:value="state.query.params.category"
          allowClear
          placeholder="请输入类型"
          @pressEnter="goPage"
          autocomplete="off"
      ...
      <a-form-item name="tag">
        <a-input
          v-model:value="state.query.params.tag"
          allowClear
          placeholder="请输入标签"
          @pressEnter="goPage"
          autocomplete="off"
      ...
      <a-form-item name="url">
        <a-input
          v-model:value="state.query.params.url"
          allowClear
          placeholder="请输入工具地址"
          @pressEnter="goPage"
          autocomplete="off"
      ...
      <a-form-item name="blank1">
        <a-input
          v-model:value="state.query.params.blank1"
          allowClear
          placeholder="请输入预留1"
          @pressEnter="goPage"
          autocomplete="off"
      ...
      <a-form-item name="blank2">
        <a-input
          v-model:value="state.query.params.blank2"
          allowClear
          placeholder="请输入预留2"
          @pressEnter="goPage"
          autocomplete="off"
      ...
      <a-form-item name="blank3">
        <a-input
          v-model:value="state.query.params.blank3"
          allowClear
          placeholder="请输入预留3"
          @pressEnter="goPage"
          autocomplete="off"
      ...
      <a-form-item name="blank4">
        <a-input
          v-model:value="state.query.params.blank4"
          allowClear
          placeholder="请输入预留4"
          @pressEnter="goPage"
          autocomplete="off"
      ...
      <a-form-item name="blank5">
        <a-input
          v-model:value="state.query.params.blank5"
          allowClear
          placeholder="请输入预留5"
          @pressEnter="goPage"
          autocomplete="off"
...
const goEdit = (row) => {
  ...
  row && row._id
    ? (state.editTitle = "修改小工具")
    : (state.editTitle = "添加小工具");
