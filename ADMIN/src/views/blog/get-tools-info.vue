<template>
  <section class="zy-get">
    ...
    >
      ...
      >
        <a-input
          v-model:value="state.form.abstract"
          allowClear
          placeholder="请输入工具简介"
        />
      </a-form-item>
      ...
      <a-form-item
        label="预留1"
        name="blank1"
        :rules="[{ required: false, message: '请输入预留1!' }]"
      >
        <a-input
          v-model:value="state.form.blank1"
          allowClear
          placeholder="请输入预留1"
        />
      </a-form-item>
      ...
      <a-form-item
        label="预留2"
        name="blank2"
        :rules="[{ required: false, message: '请输入预留2!' }]"
      >
        <a-input
          v-model:value="state.form.blank2"
          allowClear
          placeholder="请输入预留2"
        />
      </a-form-item>
      ...
      <a-form-item
        label="预留3"
        name="blank3"
        :rules="[{ required: false, message: '请输入预留3!' }]"
      >
        <a-input
          v-model:value="state.form.blank3"
          allowClear
          placeholder="请输入预留3"
        />
      </a-form-item>
      ...
      <a-form-item
        label="预留4"
        name="blank4"
        :rules="[{ required: false, message: '请输入预留4!' }]"
      >
        <a-input
          v-model:value="state.form.blank4"
          allowClear
          placeholder="请输入预留4"
        />
      </a-form-item>
      ...
      <a-form-item
        label="预留5"
        name="blank5"
        :rules="[{ required: false, message: '请输入预留5!' }]"
      >
        <a-input
          v-model:value="state.form.blank5"
          allowClear
          placeholder="请输入预留5"
        />
      </a-form-item>
