    ...
    <aside class="blog-left" :style="{ 'background-image': backgroundImg }">
      <section class="blog-l-info">
        ...
        <p class="info-title-sub ban-bred">
          <span @click="goToPage('/blog')" title="发现更多有趣的文章">
            发现更多 <i class="iconfont icon-shujuzhongxin"></i
          ></span>
        </p>
      </section>
    </aside>
        ...
        >
          <header class="blog-header" :style="{ width: !post.cover && '100%' }">
            ...
            <div class="blog-tip">
              ...
              >
              <span
                ><i class="iconfont icon-chakan2"></i> {{ post.viewNum }}</span
              >
              <!--                                                      |  <span>5条喜欢</span>-->
            </div>
          </header>
...
const backgroundImg = ref(
  "url(http://blog-server.bestplayspace.fun/v1/common/files/preview/img/1691571900783.png)"
);
...
function updateBackgroundImage() {
  backgroundImg.value = `url(http://blog-server.bestplayspace.fun/v1/common/files/preview/img/${getImageName(
    currentImageIndex
  )}.jpg)`;
