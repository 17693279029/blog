    ...
    <section class="main-warp" id="about">
              ...
              <div class="row-col-right">
                <div
                  ...
                  :style="`transform: translateX(-${
                    state.titleAnimation ? 0 : 50
                  }%)`"
                >
                  <p class="text-tip">
                    Hi! I'm {{ setting.websiteInfo.name || "GAO" }}
                  </p>
                  <p class="text-main">
                    {{
                      setting.websiteInfo.motto ||
      ...
      <section class="main-container">
          ...
          <div class="container-left">
            <div
              ...
              :style="`transform: translateY(-${
                state.titleAnimation ? 40 : 0
              }%)`"
            >
              <div class="sidebar-card">
                <div class="sidebar-avatar">
                  <img
                    class="avatar-img lazy-image"
                    :data-src="`https://i.imgur.com/1QnmmjE.jpeg`"
                  />
                </div>
                <div class="sidebar-name">
                  {{ setting.websiteInfo.occupation }}
                </div>
                <div class="sidebar-label">
                  {{ setting.websiteInfo.occupationEn }}
                </div>
                <div class="c-divider c-mb-40"></div>
                <div class="sidebar-social">
                  <a :href="setting.userInfo.github" target="_blank"
                    ><i class="iconfont icon-github"></i
                  ></a>
                  <a :href="setting.userInfo.gitee" target="_blank"
                ...
                <ul class="sidebar-other">
                  <li class="other-item">
                    ...
                    <span class="item-label-light">{{
                      setting.userInfo.city || "-"
                    }}</span>
                  </li>
                  <li class="other-item">
                    <span class="item-label">年龄：</span>
                    <span class="item-label-light">{{
                      setting.userInfo.age
                    }}</span>
                  </li>
                ...
                <span
                  class="downResume"
                  v-if="setting.userInfo.showResumeUrl"
        ...
        <img
          ...
          src="https://github-readme-stats.vercel.app/api?username=ZHYI-source&bg_color=30,e96443,904e95&title_color=fff&text_color=fff"
          alt="vuejs"
        />
        <img
          src="https://github-readme-stats.vercel.app/api/top-langs/?username=ZHYI-source&amp;layout=compact"
          alt="TopLangs"
        />
        <img
          src="https://github-readme-stats.vercel.app/api/pin/?username=ZHYI-source&repo=blog-node-express-mysql-vue2"
          alt="TopLangs"
        />
        <img
          src="https://github-readme-stats.vercel.app/api/pin/?username=ZHYI-source&repo=vue3-antd-plus"
          alt="TopLangs"
        />
        <section class="about">
          <ZySectionHeader title="About me" titleNum="02" />
          <section class="animate-me">
            "<span class="me-text me-text-a">三年前</span>，我踏上了<span
              class="me-text me-text-b"
              >前端开发</span
            >的旅程 ，从那时起，对前端技术<span class="me-text me-text-c"
              >充满热情</span
            >， 并迫不及待地构建各种<span class="me-text me-text-d">响应式</span
            >设计和<span class="me-text me-text-c">移动端</span
            >的开发。我比较注重
            <span class="me-text me-text-e">用户体验</span>、界面设计和<span
              class="me-text me-text-a"
              >代码质量</span
            >，并具有<span class="me-text me-text-c">优化性能</span
            >和解决兼容性问题的经验。 热衷于<span class="me-text me-text-c"
              >创新</span
            >思维，喜欢思考和
            <span class="me-text me-text-c">解决问题</span
            >。追求自己的兴趣和激情，让每一天都充满<span
        ...
        <section class="resume c-mt-40" id="resume">
          ...
          <div class="resume-box icon-animation" style="border: 1px solid #eee">
            <div class="box-title">
              <span
                class="title-icon iconfont icon-a-xingshizhexueshekebaogaohuishenpibiao"
              >
              </span>
          ...
          <div class="resume-box best-box">
            <div class="box-title">
              <span class="title-icon iconfont icon-zhuomian-diannaoxianshiqi">
              </span>
            ...
            <div class="box-item">
              ...
              <div class="best-text">
                热爱编程工作。每一行代码都是我对未知世界的探索.每一次bug的战胜，都是一次成长的飞跃.
              </div>
            </div>
            <div class="box-item">
              <i class="icon icon-e iconfont icon-yingxionglianmeng"></i>
              <div class="best-text">
                享受在LOL中和好友默契十足的配合，无论输赢，都是锻炼意志的历练.
              </div>
            </div>
            <div class="box-item">
              <i class="icon icon-d iconfont icon-lvyoufabu"></i>
              <div class="best-text">
                旅游是我心中永不停歇的冒险！我喜欢追逐风景，感受异域文化的魅力.
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="work-box">
            ...
            <div class="work-list">
              <div
                class="work-item"
                :title="item.abstract"
                v-for="item in state.portfoliosData"
                :key="item"
                @click="viewWorks(item)"
              >
                <img
                  class="work-cover lazy-image"
              ...
              <div class="work-item" @click="goToPage('/Portfolio')">
                <img
                  class="work-cover lazy-image"
                  v-bind:data-src="`http://localhost:3089/v1/common/files/preview/img/1691545299360.png`"
                />
              ...
              >
                ...
                <div class="item-r">
                  <p class="r-t">
                    ...
                    <span
                      class="author"
                      v-if="item.userInfo[0].username === 'admin'"
                    ></span>
                    <span class="r-t-time">{{
